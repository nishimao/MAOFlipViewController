Pod::Spec.new do |s|
  ...
  s.source_files  = "MAOFlipViewController/MAOFlipInteraction.{h,m}","MAOFlipViewController/MAOFlipTransition.{h,m}","MAOFlipViewController/MAOFlipViewController.{h,m}","MAOFlipViewController/MAOPanGestureRecognizer.{h,m}"
