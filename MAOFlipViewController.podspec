#
#  Be sure to run `pod spec lint MAOFlipViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "This is the OSS that provide interacition transition like FlipBoard."
